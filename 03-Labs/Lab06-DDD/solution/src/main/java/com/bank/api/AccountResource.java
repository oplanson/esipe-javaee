...
public class AccountResource {
     ...
     *         Response: 200 OK
     *         [
     *         {"id": 1, "number": "ACC001", "balance": 1000.00, "type":
     *         "CHECKING"},
     *         {"id": 2, "number": "ACC002", "balance": 5000.00, "type": "SAVINGS"}
     *         ]
     * @deprecated Use {@link com.bank.api.v2.AccountResourceV2#getAllAccounts()}
     *             instead
     */
    @GET
    @Deprecated(since = "1.0", forRemoval = true)
     ...
     * 
     *                           Response: 200 OK
     *                           {"id": 1, "number": "ACC001", "balance": 1000.00,
     *                           "type": "CHECKING"}
     * @deprecated Use {@link com.bank.api.v2.AccountResourceV2#getAccount(Long)}
     *             instead
     */
    @GET
    @Path("/{id}")
     ...
     * 
     *         {"number": "ACC001", "balance": 1000.00, "type": "CHECKING",
     *         "clientId": 1}
     * 
     *         Response: 201 Created
     *         {"id": 1, "number": "ACC001", "balance": 1000.00, "type": "CHECKING"}
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#createAccount(com.bank.application.dto.AccountDTO)}
     *             instead
     */
    @POST
    @Deprecated(since = "1.0", forRemoval = true)
     ...
     *                           Content-Type: application/json
     * 
     *                           {"number": "ACC001", "balance": 1500.00, "type":
     *                           "CHECKING"}
     * 
     *                           Response: 200 OK
     *                           {"id": 1, "number": "ACC001", "balance": 1500.00,
     *                           "type": "CHECKING"}
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#updateAccount(Long, com.bank.application.dto.AccountDTO)}
     *             instead
     */
    @PUT
    @Path("/{id}")
     ...
     * @deprecated Use {@link com.bank.api.v2.AccountResourceV2#deleteAccount(Long)}
     *             instead
     */
    @DELETE
    @Path("/{id}")
     ...
     *         ]
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#getClientAccounts(Long)}
     *             instead
     */
    @GET
     ...
     *         "CHECKING"}]
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#getAccountsByType(String)}
     *             instead
     */
    @GET
    @Path("/type/{type}")
     ...
     *                           "type": "CHECKING"}
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#deposit(Long, double)}
     *             instead
     */
    @POST
    @Path("/{id}/deposit")
     ...
     * 
     *                                  Response: 200 OK
     *                                  {"id": 1, "number": "ACC001", "balance":
     *                                  800.00, "type": "CHECKING"}
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#withdraw(Long, double)}
     *             instead
     */
    @POST
    @Path("/{id}/withdraw")
     ...
     *                                  Example:
     *                                  POST
     *                                  /api/accounts/1/transfer?toId=2&amount=100.00
     * 
     *                                  Response: 200 OK
     *                                  {
     *                                  "success": true,
     ...
     *                                  }
     * @deprecated Use
     *             {@link com.bank.api.v2.AccountResourceV2#transfer(Long, Long, double)}
     *             instead
     */
    @POST
    ...
    public Response transfer(
        ...
        ErrorResponse validationError = validateTransferRequest(toId, amount);
        if (validationError != null) {
            return buildErrorResponse(validationError);
        }

        Account fromAccount = findAccountOrReturnError(fromId, "Source");
        if (fromAccount == null) {
            return buildNotFoundResponse(fromId, "Source");
        }

        Account toAccount = findAccountOrReturnError(toId, "Destination");
        if (toAccount == null) {
            return buildNotFoundResponse(toId, "Destination");
        }

        boolean success = accountService.transfer(fromId, toId, amount.doubleValue());
        if (!success) {
        ...
        return buildSuccessResponse(fromAccount, toAccount);
    }

    private ErrorResponse validateTransferRequest(Long toId, BigDecimal amount) {
        if (toId == null) {
            return new ErrorResponse(400, "Destination account ID is required");
        }
        if (amount == null || amount.compareTo(BigDecimal.ZERO) <= 0) {
            return new ErrorResponse(400, "Transfer amount must be positive");
        }
        return null;
    }

    private Account findAccountOrReturnError(Long accountId, String accountType) {
        return accountService.findById(accountId);
    }

    private Response buildNotFoundResponse(Long accountId, String accountType) {
        ErrorResponse error = new ErrorResponse(404, accountType + " account with ID " + accountId + " not found");
    ...
    private Response buildErrorResponse(ErrorResponse error) {
    ...
    private Response buildConflictResponse() {
        ErrorResponse error = new ErrorResponse(409, "Transfer failed - insufficient funds or invalid operation");
    ...
    private Response buildSuccessResponse(Account fromAccount, Account toAccount) {
        return Response.ok()
     ...
     *         Response: 200 OK
     *         {"count": 15}
     * @deprecated Use {@link com.bank.api.v2.AccountResourceV2#getAccountCount()}
     *             instead
     */
    @GET
    @Path("/count")
