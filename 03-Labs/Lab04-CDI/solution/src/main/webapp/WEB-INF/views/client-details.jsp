...
<body>
    ...
    <div class="container">
        ...
        <c:if test="${param.message == 'account_created'}">
            <div class="alert alert-success">
                ✓ Account created successfully!
            </div>
        </c:if>
        <c:if test="${param.message == 'account_deleted'}">
            <div class="alert alert-success">
                    ...
                    <div class="value">
                        <c:choose>
                            <c:when test="${client.premium}">
                                <span class="badge badge-success" title="Premium client with enhanced notification services">
                                    ⭐ PREMIUM
                                </span>
                                <br><small>Enhanced multi-channel notifications (Email, SMS, Push, In-app)</small>
                            </c:when>
                            <c:otherwise>
                                <span class="badge badge-secondary" title="Standard client">
                                    STANDARD
                                </span>
                                <br><small>Basic email notifications</small>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h2>Accounts</h2>
                <a href="${pageContext.request.contextPath}/account?action=new&clientId=${client.id}"
                            ...
                            <tbody>
                                <c:forEach var="account" items="${client.accounts}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/account?action=view&id=${account.id}"
                                               class="btn btn-sm btn-info" title="View Details">👁️</a>
                                            <a href="${pageContext.request.contextPath}/account?action=edit&id=${account.id}"
    ...
    <footer>
        <div class="container">
            <p>&copy; 2025 Banking Application - Lab 04</p>
