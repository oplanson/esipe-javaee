 ...
 * Updated for Lab 3 with JPA persistence (no CDI required).
 */
@WebServlet(
...
public class ClientController extends HttpServlet {
     ...
     * Gets ClientService instance using Singleton pattern.
     */
    @Override
    public void init() throws ServletException {
        ...
        // Note: Sample data is now loaded via Flyway migrations (V1 and V2)
        // No need to call initializeSampleData() anymore
