...
public class Money {
     ...
     * Note: Money constructor prevents negative amounts, so this always returns false.
     * Kept for API completeness.
     *
     * @return true if amount is negative (always false for valid Money)
     */
    ...
    /**
     * Check if this money is negative or zero.
     *
