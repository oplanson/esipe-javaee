    ...
    <div class="container">
                            ...
                            <tbody>
                                <c:forEach var="account" items="${client.accounts}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/accounts/${account.id}"
                                            ...
                                            <c:if test="${deletionEnabled}">
                                                <form method="post"
                                                      action="${pageContext.request.contextPath}/accounts/${account.id}/close"
        ...
        <div class="card mt-3">
            <div class="btn-group">
                ...
                <c:if test="${deletionEnabled}">
                    <form method="post"
                          action="${pageContext.request.contextPath}/clients/${client.id}/delete"
                          style="display:inline;"
