 ...
 * Executes Flyway migrations on application startup
 */
@Singleton
@Startup
public class DatabaseMigrationStartup {
    ...
    public void init() {
        ...
        try {
            ...
            String dbHost = System.getenv().getOrDefault("DB_HOST", "banking-client-db");
            String dbPort = System.getenv().getOrDefault("DB_PORT", "5432");
            String dbName = System.getenv().getOrDefault("DB_NAME", "banking_client_db");
